    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="nombre" class="block w-full mt-1" type="text" name="nombre" :value="old('nombre')" required autofocus autocomplete="name" />
            </div>
            <div>
                <x-label for="apellido_paterno" value="{{ __('Apellido Paterno') }}" />
                <x-input id="apellido_paterno" class="block w-full mt-1" type="text" name="apellido_paterno" :value="old('apellido_paterno')" required autofocus autocomplete="name" />
            </div>
            <div>
                <x-label for="apellido_materno" value="{{ __('Apellido Paterno') }}" />
                <x-input id="apellido_materno" class="block w-full mt-1" type="text" name="apellido_materno" :value="old('apellido_materno')" required autofocus autocomplete="name" />
            </div>
            <div class="mt-4">
