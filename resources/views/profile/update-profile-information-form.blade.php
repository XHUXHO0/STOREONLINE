<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nombre" type="text" class="block w-full mt-1" wire:model.defer="state.nombre" autocomplete="nombre" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="apellido_paterno" type="text" class="block w-full mt-1" wire:model.defer="state.apellido_paterno" autocomplete="name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="apellido_materno" type="text" class="block w-full mt-1" wire:model.defer="state.apellido_materno" autocomplete="name" />
